...
const uint32_t TOTAL_BLOCKS = 8192;//76;//1048576;//1048576;//1048576;//1048576;//1048576;//1048576;//1048576;//1048576;//1048576;//16777216;//1048576; ///2^20
...
const uint32_t MAX_T_SIZE = 8192;//76;//16777216;
...
const uint32_t BIT_MASK = 0x001FFF;
/****************************************FileNames****************************************/ 
