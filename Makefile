...
CFLAGS=-c -ggdb
LDFLAGS=-lcryptopp -L/Users/naveed/BStore/src/cryptopp562 -lboost_system-mt -lboost_filesystem-mt -lboost_iostreams-mt -L/usr/local/Cellar/boost/1.54.0/lib -I/usr/local/Cellar/boost/1.54.0/include /Users/naveed/BStore/test/*.cc -llzo -L/usr/local/lib -I/usr/local/include
