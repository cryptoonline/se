...
CFLAGS=-c -g
LDFLAGS=-lcryptopp -lboost_system-mt -lboost_filesystem-mt -lboost_iostreams-mt -I /Users/naveed/BStore/test/framework/gtest-1.7.0/include/ /Users/naveed/BStore/test_Oakland/singleTest/*.cc /Users/naveed/BStore/test/framework/gtest-1.7.0_build/libgtest.a -I/user/local/include
...
SOURCE_DIR=src_Oakland/
OBJECT_DIR=obj_Oakland/
BIN_DIR=bin_Oakland/
