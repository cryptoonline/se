...
SOURCES=AES.cpp CRIBlock.cpp CRI.cpp DataBlock.cpp Ddisk.cpp TBlock.cpp Tdisk.cpp HashMAC.cpp PRF.cpp PRSubset.cpp fileID.cpp TruncAES.cpp Key.cpp Debug.cpp helper.cpp 
