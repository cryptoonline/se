...
SOURCES=AES.cpp BStore.cpp CRIBlock.cpp CRI.cpp DataBlock.cpp Ddisk.cpp DiskCommunicator.cpp TBlock.cpp Tdisk.cpp HashMAC.cpp PRF.cpp PRSubset.cpp fileID.cpp TruncAES.cpp Key.cpp OnlineSession.cpp Debug.cpp helper.cpp 
